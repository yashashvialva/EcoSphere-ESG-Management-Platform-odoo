...
const MainLayout = () => {
  ...
  const navigation = [
    ...
    // Social Links
    { name: 'CSR Activities', href: '/social/csr-activities', icon: Leaf, color: 'text-blue-500' },
    { name: 'Training', href: '/social/training', icon: BookOpen, color: 'text-blue-500' },
    { name: 'Diversity', href: '/social/diversity', icon: Users, color: 'text-blue-500' },
